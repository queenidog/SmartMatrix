...
#include <MatrixHardware_Teensy3_ShieldV4.h>        // SmartLED Shield for Teensy 3 (V4)modified version
...
const uint8_t kPanelType = SM_PANELTYPE_HUB75_16ROW_MOD8SCAN_FEMod;
#endif
