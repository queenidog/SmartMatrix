...
#include <MatrixHardware_Teensy3_ShieldV4.h>        // SmartLED Shield for Teensy 3 (V4)  FE version using own PCB for Shield
...
const uint8_t kPanelType = SM_PANELTYPE_HUB75_16ROW_MOD8SCAN_FEMod;   // For FE: 16 row, mod 8
